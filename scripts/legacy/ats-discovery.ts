...
const SOURCES_PATH = path.resolve(__dirname, '../../../lib/registry/jobsieve-sources.json');
const REGISTRY_PATH = path.resolve(__dirname, '../../../lib/registry/company-registry.ts');
