...
import { FitScoringService, ScoringProfile } from './fit-scoring.service';
  ...
  describe('ambiguous stack term "Go" — structured-only matching', () => {
    ...
    it('gives no stack point when "go" appears only in description prose', () => {
      const job = makeJob({
        ...
        description:
          'We move fast and go to market quickly with go-getter mindset.',
        tags: [],
      });
